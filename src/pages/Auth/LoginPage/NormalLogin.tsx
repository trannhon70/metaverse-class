...
const NormalLogin: React.FC<LoginPageType> = ({ changeMode }) => {
  ...
  return (
    <div className="relative w-full flex justify-center font-itim mt-[5%]">
      <div className="relative w-[1000px] aspect-[1.6] bg-gray-300">
        <div className="relative w-full h-full flex flex-col  bg-[url('@/assets/backgrounds/login-bg.jpg')] bg-cover shadow-lg">
          <button
